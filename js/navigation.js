$(document).ready(function() {
	...
	var x = decodeURIComponent((new RegExp('[?|&]x=' + '([^&;]+?)(&|#|;|$)', "ig").exec(location.search) || [, ""])[1].replace(/\+/g, '%20')) || null;
	var y = decodeURIComponent((new RegExp('[?|&]y=' + '([^&;]+?)(&|#|;|$)', "ig").exec(location.search) || [, ""])[1].replace(/\+/g, '%20')) || null;
	var golf_name = decodeURIComponent((new RegExp('[?|&]name=' + '([^&;]+?)(&|#|;|$)', "ig").exec(location.search) || [, ""])[1].replace(/\+/g, '%20')) || null;
