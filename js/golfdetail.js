		...
		var id = decodeURIComponent((new RegExp('[?|&]id=' + '([^&;]+?)(&|#|;|$)', "ig").exec(location.search) || [, ""])[1].replace(/\+/g, '%20')) || null;
			...
			$.ajax({
				...
				.done(function(data) {
					...
					var html = "";
					html += '<div class="banner">  <div class="tianqi"><a href="weather.html?id='+golfdetail.id+'"><div class="tianqi_img"><img src="'+golfdetail.weather_info.pic+'"></div><div class="tianqi_des"><p>'+golfdetail.weather_info.temperature+'°C '+golfdetail.weather_info.weather+'</p><p>'+golfdetail.weather_info.winddirection+'风'+golfdetail.weather_info.windpower+'级 降水量'+golfdetail.weather_info.humidity+'mm</p></div></a></div>   <div class="swiper-container"><div class="swiper-wrapper" id="banner">';
